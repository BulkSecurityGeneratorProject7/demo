...
import { DepartmentComponentsPage, DepartmentDeleteDialog, DepartmentUpdatePage } from './department-job-order.page-object';
...
describe('Department e2e test', () => {
    ...
    it('should load Departments', async () => {
        await navBarPage.goToEntity('department-job-order');
        departmentComponentsPage = new DepartmentComponentsPage();
        expect(await departmentComponentsPage.getTitle()).to.eq('prestozoomApp.department.home.title');
    });
    ...
    it('should load create Department page', async () => {
        ...
        expect(await departmentUpdatePage.getPageTitle()).to.eq('prestozoomApp.department.home.createOrEditLabel');
    ...
    it('should delete last Department', async () => {
        ...
        expect(await departmentDeleteDialog.getDialogTitle()).to.eq('prestozoomApp.department.delete.question');
