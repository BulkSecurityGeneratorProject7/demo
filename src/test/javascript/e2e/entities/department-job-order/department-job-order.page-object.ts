...
export class DepartmentComponentsPage {
    ...
    deleteButtons = element.all(by.css('jhi-department-job-order div table .btn-danger'));
    title = element.all(by.css('jhi-department-job-order div h2#page-heading span')).first();
...
export class DepartmentUpdatePage {
    pageTitle = element(by.id('jhi-department-job-order-heading'));
