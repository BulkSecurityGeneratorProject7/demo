...
export class JobComponentsPage {
    ...
    deleteButtons = element.all(by.css('jhi-job-job-order div table .btn-danger'));
    title = element.all(by.css('jhi-job-job-order div h2#page-heading span')).first();
...
export class JobUpdatePage {
    pageTitle = element(by.id('jhi-job-job-order-heading'));
