...
export class LocationComponentsPage {
    ...
    deleteButtons = element.all(by.css('jhi-location-job-order div table .btn-danger'));
    title = element.all(by.css('jhi-location-job-order div h2#page-heading span')).first();
...
export class LocationUpdatePage {
    pageTitle = element(by.id('jhi-location-job-order-heading'));
