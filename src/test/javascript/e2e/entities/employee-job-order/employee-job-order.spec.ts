...
import { EmployeeComponentsPage, EmployeeDeleteDialog, EmployeeUpdatePage } from './employee-job-order.page-object';
...
describe('Employee e2e test', () => {
    ...
    it('should load Employees', async () => {
        await navBarPage.goToEntity('employee-job-order');
        employeeComponentsPage = new EmployeeComponentsPage();
        expect(await employeeComponentsPage.getTitle()).to.eq('prestozoomApp.employee.home.title');
    });
    ...
    it('should load create Employee page', async () => {
        ...
        expect(await employeeUpdatePage.getPageTitle()).to.eq('prestozoomApp.employee.home.createOrEditLabel');
    ...
    it('should delete last Employee', async () => {
        ...
        expect(await employeeDeleteDialog.getDialogTitle()).to.eq('prestozoomApp.employee.delete.question');
