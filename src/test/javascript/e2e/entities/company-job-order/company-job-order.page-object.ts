...
export class CompanyComponentsPage {
    ...
    deleteButtons = element.all(by.css('jhi-company-job-order div table .btn-danger'));
    title = element.all(by.css('jhi-company-job-order div h2#page-heading span')).first();
...
export class CompanyUpdatePage {
    pageTitle = element(by.id('jhi-company-job-order-heading'));
