...
export class TaskComponentsPage {
    ...
    deleteButtons = element.all(by.css('jhi-task-job-order div table .btn-danger'));
    title = element.all(by.css('jhi-task-job-order div h2#page-heading span')).first();
...
export class TaskUpdatePage {
    pageTitle = element(by.id('jhi-task-job-order-heading'));
