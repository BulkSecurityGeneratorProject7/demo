...
export class JobHistoryComponentsPage {
    ...
    deleteButtons = element.all(by.css('jhi-job-history-job-order div table .btn-danger'));
    title = element.all(by.css('jhi-job-history-job-order div h2#page-heading span')).first();
...
export class JobHistoryUpdatePage {
    pageTitle = element(by.id('jhi-job-history-job-order-heading'));
