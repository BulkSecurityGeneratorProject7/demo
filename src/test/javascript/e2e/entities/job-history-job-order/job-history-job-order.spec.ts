...
import { JobHistoryComponentsPage, JobHistoryDeleteDialog, JobHistoryUpdatePage } from './job-history-job-order.page-object';
...
describe('JobHistory e2e test', () => {
    ...
    it('should load JobHistories', async () => {
        await navBarPage.goToEntity('job-history-job-order');
        jobHistoryComponentsPage = new JobHistoryComponentsPage();
        expect(await jobHistoryComponentsPage.getTitle()).to.eq('prestozoomApp.jobHistory.home.title');
    });
    ...
    it('should load create JobHistory page', async () => {
        ...
        expect(await jobHistoryUpdatePage.getPageTitle()).to.eq('prestozoomApp.jobHistory.home.createOrEditLabel');
    ...
    it('should create and save JobHistories', async () => {
        ...
        await promise.all([
            ...
            jobHistoryUpdatePage.invoiceSelectLastOption()
        ]);
    ...
    it('should delete last JobHistory', async () => {
        ...
        expect(await jobHistoryDeleteDialog.getDialogTitle()).to.eq('prestozoomApp.jobHistory.delete.question');
