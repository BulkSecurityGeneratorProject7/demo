...
import { EmployeeJobOrderComponent } from 'app/entities/employee-job-order/employee-job-order.component';
...
describe('Component Tests', () => {
    describe('EmployeeJobOrder Management Component', () => {
        let comp: EmployeeJobOrderComponent;
        let fixture: ComponentFixture<EmployeeJobOrderComponent>;
        let service: EmployeeJobOrderService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [PrestozoomTestModule],
                declarations: [EmployeeJobOrderComponent],
                providers: [
                    {
                ...
                .overrideTemplate(EmployeeJobOrderComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(EmployeeJobOrderComponent);
