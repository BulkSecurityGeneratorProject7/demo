...
import { JobJobOrderComponent } from 'app/entities/job-job-order/job-job-order.component';
...
describe('Component Tests', () => {
    describe('JobJobOrder Management Component', () => {
        let comp: JobJobOrderComponent;
        let fixture: ComponentFixture<JobJobOrderComponent>;
        let service: JobJobOrderService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [PrestozoomTestModule],
                declarations: [JobJobOrderComponent],
                providers: [
                    {
                ...
                .overrideTemplate(JobJobOrderComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(JobJobOrderComponent);
