...
@Component({
    selector: 'jhi-job-history-job-order',
    templateUrl: './job-history-job-order.component.html'
})
export class JobHistoryJobOrderComponent implements OnInit, OnDestroy {
    jobHistories: IJobHistoryJobOrder[];
    currentAccount: any;
    ...
    loadAll() {
        this.jobHistoryService
            ...
            .subscribe(
                (res: HttpResponse<IJobHistoryJobOrder[]>) => this.paginateJobHistories(res.body, res.headers),
    ...
    trackId(index: number, item: IJobHistoryJobOrder) {
        return item.id;
    }
    ...
    private paginateJobHistories(data: IJobHistoryJobOrder[], headers: HttpHeaders) {
