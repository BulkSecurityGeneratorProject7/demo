...
@Component({
    selector: 'jhi-location-job-order',
    templateUrl: './location-job-order.component.html'
})
export class LocationJobOrderComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: ILocationJobOrder) {
        return item.id;
    }
